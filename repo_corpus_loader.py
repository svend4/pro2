...
CLUSTER_DEFS = {
    "Theory": {
        ...
        "description": "Теоретические MD-документы: онтология, концепции, анализ + data2 ETD/AI",
        "globs": [
            "*.md",
            "yijing_transformer/*.md",
            # data2 (ETD Крюкова): AI/ML/математика/теория движения
            # Приоритет A — ядро ETD + AI
            "data/svend4_corpus/data2/_clones/data2/SESSION_Deformed_Figure8_Scarab_Algorithm.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_07_AI_and_Machine_Learning.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_15_Deep_Learning_Architectures.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_20_Grand_Unified_Theory.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_36_Artificial_Intelligence.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_41_Mathematical_Foundations.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_42_ETD_Axiomatics.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_48_AI_Architecture.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_62_Information_Theory.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_64_Topology_Geometry.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_70_Complexity_Chaos.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_71_AI_MachineLearning.md",
            # Приоритет B — продвинутая математика (spektr, топология, инфогеометрия)
            "data/svend4_corpus/data2/_clones/data2/VOLUME_104_Conservation_Laws_LCI.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_106_Topology_4Points.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_115_GroupAxioms_ETD.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_135_Boolean_Logic.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_136_CategoryTheory.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_149_FourTransforms.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_157_InformationTheory.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_179_SpectralTheory.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_185_LieGroups.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_191_CodingTheory.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_199_AlgebraicTopology.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_213_TDA.md",
    ...
    "Self": {
        ...
        "alpha":       0,
        "e2_phase":    3,        # MethodLevel (α=0)
        "description": "Самознание: корневые .py, логи обучения, отчёты, config + Крюков ETD",
        "globs": [
            "*.py",
            ...
            "PLAN*.md",
            "*_log.json",
            # data2: Крюков ETD как метод саморефлексии (AERO-домен: ветер/метод)
            "data/svend4_corpus/data2/_clones/data2/VOLUME_99_TSB_Kryukov_ETD.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_01_Movement_Archetypes_Analysis.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_103_Quaternion_4Spheres.md",
            "data/svend4_corpus/data2/_clones/data2/VOLUME_107_4Invariant_Transformations.md",
        ],
        "exclude_patterns": ["__pycache__", "train_e2_clusters.py",
                             "repo_corpus_loader.py", ".git"],
    },
}
