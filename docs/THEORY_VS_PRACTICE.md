...
| Реализация компонентов | **8.0 / 10** | *(было 7.0)* Q6Arithmetic + YiJingOps закрывают последние теор. пробелы |
| Интеграция теория→код | **7.5 / 10** | *(было 6.5)* все «только теория» пункты реализованы кроме bent-функций |
...
> **2026-03-24**: Все 3 пункта из «только в теории» закрыты. Остаётся 1 пункт — bent-функции, частично в meta_q6.py.
