...
v69:      Bridge Utils (оптимизаторы/шедулеры/регуляризация)  → PPL 1.01 (nautilus+WSD)
```
...
- **В interlingua_fixed эксперименте:** diversity loss стабилизировалась на -0.0029 к шагу 3000, temperature полностью отожжена до 0.05
...
- Coherence-adaptive temperature, Mirostat v2 sampling
- **Результат:** PPL generation 11.2 → 9.9 (+12.1%), русский текст 15.6 → 9.0 (+42%)

**PPL по доменам (baseline v1):**
- Comfort zone: Python pytest 14.7, Python class 10.4, React 11.7, Imports 8.0
- Discomfort zone: Medical 217, Legal 266, Poetry 548, Chemistry 231, Nonsense 649
- Russian docs: 64.2 (→ 9.0 с domain locking)
...
| v69 | nautilus_adamw_wsd | **1.01** | **-66%** | `benchmark_v69_bridge_utils_results.json` |
...
| Эксперимент | PPL | Routing Conf | Время | Результат |
|-------------|-----|-------------|-------|-----------|
| lean_baseline | 1.51 | — | 321s | Reference |
| interlingua_fixed | 1.17 | — | 418s | **PROVEN** (-22.4%) |
| kasatkin_as_router | 1.04 | 34.5% | 739s | **PROVEN** (-31.5%) |
| meta_hexlearn_router | 1.02 | 1.8% | 655s | DISPROVEN (routing) / BEST PPL |
| palace_block_sparse | 6.93 | — | 1047s | DISPROVEN |
| solan_nautilus | 6.93 | — | — | DISPROVEN |
...
- WSD scheduler (v69) даёт лучшие результаты: nautilus_adamw_wsd PPL 1.0103
- AGC регуляризация эффективна: nautilus_adamw_agc PPL 1.0117
- Top-5 конфигов v69: nautilus_wsd (1.010), post_cascade_wsd (1.011), post_cascade_agc (1.011), nautilus_agc (1.012), post_cascade_adamw (1.013)
