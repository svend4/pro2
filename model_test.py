...
# Полные имена гексаграмм (первые 64)
HEX_NAMES_RU = [
    "Творчество",  "Исполнение", "Начало",          "Юность",
    "Ожидание",    "Конфликт",   "Войско",           "Единение",
    "Малое накоп.","Хождение",   "Мир",              "Застой",
    "Братство",    "Великое",    "Скромность",       "Воодушевление",
    "Следование",  "Исправление","Горное",           "Созерцание",
    "Укус",        "Украшение",  "Распад",           "Возврат",
    "Беспорочность","Велик.накоп","Питание",          "Избыток",
    "Бездна",      "Красота",    "Взаимодействие",   "Длительность",
    "Отступание",  "Велик.мощь", "Прогресс",         "Затмение",
    "Семья",       "Разрыв",     "Малые преграды",   "Освобождение",
    "Уменьшение",  "Умножение",  "Прорыв",           "Соединение",
    "Собирание",   "Подъём",     "Угнетение",        "Колодец",
    "Революция",   "Котёл",      "Гром",             "Гора",
    "Постепенность","Невеста",   "Изобилие",         "Путник",
    "Ветер",       "Радость",    "Рассеивание",      "Ограничение",
    "Правда",      "Малые преп.","Уже завершено",    "Ещё не завершено",
]
